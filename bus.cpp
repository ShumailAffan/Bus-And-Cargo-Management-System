...
void Bus::addBus()
{
    ...
    cout << "\n\t\t\t\t\t\t\t\t\t\tEnter DepartureFrom:-> ";
    cin.getline(DepartureFrom, 20);
    cout << "\n\t\t\t\t\t\t\t\t\t\tEnter Destination:-> ";
    cin.getline(destination, 20);
    cout << "\n\t\t\t\t\t\t\t\t\t\tEnter DepartureFrom Time:-> ";
    cin.getline(DepartureFromTime, 20);
...
void Bus::showBusDetails()
{
    ...
    cout << "\n\t\t\t\t\t\t\t\t\t\t DepartureFrom:-> " << getDepartureFrom();
    cout << "\n\t\t\t\t\t\t\t\t\t\t Destination:-> " << getDestination();
    cout << "\n\t\t\t\t\t\t\t\t\t\t Time:-> " << getDepartureFromTime() << " - " << getDestinationTime();
